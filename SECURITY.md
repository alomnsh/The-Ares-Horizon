# Security Policy: The Ares Horizon

Thank you for helping keep *The Ares Horizon* safe and secure for all players and developers.
...
| ---------------- | ------------------ |
| Live Web Build   | :white_check_mark: |
...
* Clear, step-by-step instructions or a proof-of-concept file to reproduce the behavior.
* The specific version number or Release Tag where the vulnerability was found.
* Your operating environment (e.g., Windows 11 Desktop or Google Chrome Browser).
